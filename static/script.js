...
$(document).ready(function() {
    ...
    function sendData(e){
        ...
        $.ajax({
            url: '${config.url}/templates/?${queryBuilder}&${cacheBuster}/',
            method: 'GET',
            dataType: 'json',
            cache: false,
    ...
    function changeWhiteLed(frequency){
        $.ajax({
            url: '${config.url}/templates/white?white=${frequency}&${cacheBuster}/',
            method: 'GET',
            success: function(result) {
                console.log(result);
            }
    ...
    function getLEDStatus(color) {
        $.ajax({
            url: '${config,url}/templates/getStatus?colors=${color}&${cacheBuster}/',
            method: 'GET',
            success: function(result) {
                if(color == 'rgb') {
